...
class ContactAdapter(var listener: ClickItemContactListner):
    ...
    class ContactAdapterViewHolder(itemView: View, var list: List<Contact>, var listener: ClickItemContactListner):
